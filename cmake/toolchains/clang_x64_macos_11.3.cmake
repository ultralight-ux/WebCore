if (DEFINED TOOLCHAIN_X64_MACOS_11_3_CMAKE)
  return ()
else ()
  set(TOOLCHAIN_X64_MACOS_11_3_CMAKE 1)
endif ()
...
set(CMAKE_SYSROOT "/Library/Developer/CommandLineTools/SDKs/MacOSX11.3.sdk"      CACHE PATH    "(macOS only) The path to the macOS platform SDK.")
set(CMAKE_OSX_DEPLOYMENT_TARGET "11.3"                                           CACHE STRING  "(macOS only) The minimum macOS deployment target.")
...
set(UL_SKIA_CFLAGS -arch x86_64 -mmacosx-version-min=11.3)
