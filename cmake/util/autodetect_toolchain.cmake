if (NOT CMAKE_TOOLCHAIN_FILE)
    ...
    elseif (CMAKE_HOST_SYSTEM_NAME MATCHES "Darwin")
        ...
        #get_filename_component(CMAKE_TOOLCHAIN_FILE "../toolchains/clang_x64_macos_11.3.cmake"
                               REALPATH BASE_DIR "${CMAKE_CURRENT_LIST_DIR}")    
    elseif (CMAKE_HOST_SYSTEM_NAME MATCHES "Linux")
        get_filename_component(CMAKE_TOOLCHAIN_FILE "../toolchains/clang_x64_linux_ubuntu_20.04.cmake"
                               REALPATH BASE_DIR "${CMAKE_CURRENT_LIST_DIR}")    
    else ()
