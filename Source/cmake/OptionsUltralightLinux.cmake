...
if (${BUILD_DBG})
  ...
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -g -DNDEBUG -ffunction-sections -fdata-sections -fPIC -std=c++14
                       ...
                       -Wno-shorten-64-to-32 -Wno-c++11-extensions -Wdeprecated-declarations
                       -Winvalid-offsetof -fvisibility=hidden -fno-threadsafe-statics -Wno-sign-conversion
                       -Winfinite-recursion -Wno-strict-prototypes -DU_SHOW_CPLUSPLUS_API=0")
else ()
  # Release Config
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Oz -DNDEBUG -fPIC")
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=core2 -mtune=haswell -Oz -DNDEBUG -ffunction-sections
                       -fdata-sections -fPIC -std=c++14 -Wno-trigraphs -fno-exceptions
