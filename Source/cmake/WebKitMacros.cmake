...
macro(_WEBKIT_TARGET _target_logical_name _target_cmake_name)
    ...
    if (${_target_logical_name}_LINK_OPTIONS)
        target_link_options(${_target_cmake_name} PRIVATE ${${_target_logical_name}_LINK_OPTIONS})
    endif ()
...
macro(WEBKIT_FRAMEWORK _target)
    ...
    if (APPLE AND NOT PORT STREQUAL "GTK" AND NOT PORT STREQUAL "UltralightMac" AND NOT ${${_target}_LIBRARY_TYPE} MATCHES STATIC)
