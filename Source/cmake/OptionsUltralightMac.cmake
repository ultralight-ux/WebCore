...
set(SDK_SYSROOT "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk")

if (${BUILD_DBG})
  # Debug Config
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -g -DNDEBUG -fPIC")
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -arch x86_64 -g -DNDEBUG -fPIC -std=gnu++14 -stdlib=libc++
                       -Wno-trigraphs -fno-exceptions -Wno-missing-field-initializers -Wnon-virtual-dtor
                       -Wno-overloaded-virtual -Wno-exit-time-destructors -Wno-missing-braces -Wparentheses
                       ...
                       -Wno-shorten-64-to-32 -Wno-c++11-extensions -isysroot ${SDK_SYSROOT}
                       -Wdeprecated-declarations -Winvalid-offsetof -fvisibility=hidden -fno-threadsafe-statics
                       -Wno-sign-conversion -Winfinite-recursion -Wmove -Wno-comma -Wblock-capture-autoreleasing
                       -Wno-strict-prototypes -Wno-nonportable-include-path -frtti")
else ()
  # Release Configs
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Oz -DNDEBUG -fPIC")
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -arch x86_64 -march=core2 -mtune=haswell -Oz -DNDEBUG -fPIC
                       -std=gnu++14 -stdlib=libc++ -Wno-trigraphs -fno-exceptions
                       -Wno-missing-field-initializers -Wnon-virtual-dtor -Wno-overloaded-virtual
